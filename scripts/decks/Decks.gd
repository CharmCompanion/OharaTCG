...
@onready var starter_toggle: OptionButton = %StarterToggle
@onready var back_button: Button = %BackButton
@onready var rename_button: Button = %RenameButton
@onready var save_button: Button = %SaveDeckButton
@onready var delete_button: Button = %DeleteButton
@onready var export_button: Button = %ExportButton
@onready var clear_main_button: Button = %ClearMainDeckButton
...
@onready var apply_filters_button: Button = %ApplyFiltersButton
@onready var clear_button: Button = %ClearButton
@onready var color_dropdown: OptionButton = %ColorDropdown
